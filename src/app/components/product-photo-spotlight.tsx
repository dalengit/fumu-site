...
export function ProductPhotoSpotlight({ content }: ProductPhotoSpotlightProps): JSX.Element {
  return (
    <section
      ...
      className="mt-12 w-full scroll-mt-32 sm:mt-16 sm:scroll-mt-24 lg:mt-24 xl:mx-auto xl:w-[calc(50%+200px)]"
    >
      ...
      <div className="grid grid-cols-1 items-stretch gap-4 px-4 py-5 sm:px-6 sm:py-6 lg:grid-cols-12">
