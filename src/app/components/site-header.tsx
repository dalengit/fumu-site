                ...
                <nav aria-label="Primary" className="flex w-full flex-wrap items-center justify-center gap-1 sm:w-auto sm:justify-end sm:gap-2">
                    {navLinks.map((link) => (
                        <a
                            ...
                            className={`motion-lift min-h-11 rounded-none px-2 py-2 font-mono text-[11px] uppercase tracking-[0.18em] transition-colors sm:min-h-0 sm:px-3 sm:py-1 sm:text-xs sm:tracking-widest ${link.label === "PRODUCTS"
