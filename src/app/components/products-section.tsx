...
export function ProductsSection({ products }: ProductsSectionProps): JSX.Element {
    ...
    return (
        <>
            <section id="products" className="mt-12 w-full scroll-mt-32 rounded-none border border-black sm:mt-16 sm:scroll-mt-24 lg:mt-24 xl:mx-auto xl:w-[calc(50%+200px)]">
